        ...
        function e() {
            var e = this,
                ...
                s = function() {
                    var t = r(),
                        n = t.val(),
                        i = t.data("html") ? t.data("html") : t.text();
                    l(null, {
                ...
                $ = function() {
                    var n, i, a = e.$widget.find('a[data-rating-value="' + c() + '"]'),
                        r = o("userOptions").initialRating,
                        l = t.isNumeric(c()) ? c() : 0,
                        s = m(r);
                    if (b(), a.addClass("br-selected br-selected")[g()]().addClass("br-selected"), !o("ratingMade") && t.isNumeric(r)) {
                        if (l >= r || !s) return;
                ...
                x = function(e) {
                    e.on("mouseenter.barrating", function() {
                        var e = t(this);
                        if (!e.hasClass('disabled')) { b(), e.addClass("br-active")[g()]().addClass("br-active"), v(e.attr("data-rating-text"))}
                    })
                },
                C = function(t) {
            ...
            this.show = function() {
                o() || (n(), s(), e.$widget = f(), e.$widget.insertAfter(e.$elem), $(), v(), M(e.options.readonly), e.$elem.hide())
            }, this.readonly = function(t) {
                "boolean" == typeof t && o("readOnly") != t && (M(t), l("readOnly", t), e.$widget.toggleClass("br-readonly"))
            }, this.set = function(t) {
                var n = o("userOptions");
                ...
                var t = c(),
                    n = d(),
                    a = o("userOptions");
                j(e.$widget.find("a")), e.$widget.remove(), u(), i(), e.$elem.show(), a.onDestroy.call(this, t, n)
            }
        }
